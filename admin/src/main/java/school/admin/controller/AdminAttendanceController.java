...
public class AdminAttendanceController {
    ...
    public ResponseEntity<TeacherAttendanceDto> updateTeacherAttendance(@PathVariable Long attendanceId,@Valid @RequestBody TeacherAttendanceDto attendanceDto) {
